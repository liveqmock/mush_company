...
}), e.jQuery = e.$ = b, typeof define == "function" && define.amd && define.amd.jQuery && define("biz_common/jquery-1.9.1.js", [], function(e, t, n) {
try {
var r = +(new Date);
return b;
} catch (i) {
wx.jslog({
src: "biz_common/jquery-1.9.1.js"
}, i);
}
});
})(window);;var tpl = template = function(e, t) {
