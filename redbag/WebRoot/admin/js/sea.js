...
function f(e){
var t=b.map,r=e;
if(t)for(var n=0,a=t.length;a>n;n++){
var i=t[n];
...
function l(e,t){
var r,n=e.charAt(0);
if($.test(e))r=e;else if("."===n)r=i((t?a(t):b.cwd)+e);else if("/"===n){
var s=b.cwd.match(k);
...
function h(e,t,r){
var n=K.test(e),a=L.createElement(n?"link":"script");
if(r){
var i=w(r)?r(e):r;
i&&(a.charset=i);
}
...
var _=e.seajs={
version:"2.1.1"
},b=_.data={},A=r("Object"),T=r("String"),D=Array.isArray||r("Array"),w=r("Function"),S=0,N=b.events={};
_.on=function(e,t){
var r=N[e]||(N[e]=[]);
return r.push(t),_;
},_.off=function(e,t){
...
var i=r.factory,s=w(i)?i(e,r.exports={},r):i;
...
for(var t in e){
var r=e[t],n=b[t];
if(n&&A(n))for(var a in r)n[a]=r[a];else D(n)?r=n.concat(r):"base"===t&&("/"===r.slice(-1)||(r+="/"),
r=l(r)),b[t]=r;
}
return j("config",e),_;
};
