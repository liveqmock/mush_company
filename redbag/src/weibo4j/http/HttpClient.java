	...
	public Response httpRequest(HttpMethod method, Boolean WithTokenHeader)
		...
		try {
			...
			if (WithTokenHeader) {
				...
				headers.add(new Header("User-Agent", "Mozilla/5.0 (iPhone; CPU iPhone OS 7_0 like Mac OS X; en-us) AppleWebKit/537.51.1 (KHTML, like Gecko) Version/7.0 Mobile/11A465 Safari/9537.53"));
